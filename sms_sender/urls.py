...
from .views import SmsSenderViewSet, SendSmsFlexibleView, TemplatePreviewView, TestEskizTokenView
...
urlpatterns = [
    ...
    path('template-preview/<int:template_id>/', TemplatePreviewView.as_view(), name='template-preview'),
    path('test-token/', TestEskizTokenView.as_view(), name='test-eskiz-token'),
]